...
export default function Home() {
  ...
  return (
    ...
    <p className='text-white mt-[5vh] text-center text-9xl sm:text-[10rem] leading-none mb-[5vh]' style={{fontFamily:"'Minecraftia', sans-serif"}}>1:200</p>
    ...
    <div className='flex bg-mcbg1 bg-fixed w-full bg-no-repeat bg-cover h-[40vh]'>
